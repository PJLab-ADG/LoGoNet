...
# Transformer(d_model=64,dropout=0.1,nhead=4,dim_feedforward=256,num_encoder_layers=3,num_decoder_layers=1,normalize_before=False,return_intermediate_dec=True)
