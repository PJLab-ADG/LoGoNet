...
class DataBaseSampler(object):
    ...
    def add_sampled_boxes_to_scene(self, data_dict, sampled_gt_boxes, total_valid_sampled_dict):
        ...
        # def visualize_pts(pts, fig=None, ptscolor=(1, 1, 1), bgcolor=(0, 0, 0), fgcolor=(1.0, 1.0, 1.0),
        ...
        #                           colormap='gnuplot', scale_factor=1, figure=fig, color=ptscolor)
        #     else:
