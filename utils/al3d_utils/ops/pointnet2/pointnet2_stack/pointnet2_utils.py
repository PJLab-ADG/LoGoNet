...
from al3d_utils.ops.pointnet2.pointnet2_stack import pointnet2_stack_cuda as pointnet2
...
farthest_point_sample = furthest_point_sample = FurthestPointSampling.apply
